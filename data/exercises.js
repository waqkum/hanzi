...
const EXERCISES = {
  ...
  '2-1': [
    ...
    { type:'truefalse', label:'LISTENING · Q1 · P.1',
      glyph:'⚽', glyphAlt:'two boys playing football',
    ...
    { type:'truefalse', label:'LISTENING · Q2 · P.1',
      glyph:'👕', glyphAlt:'clothes hanging on a washing line',
    ...
    { type:'truefalse', label:'LISTENING · Q3 · P.1',
      glyph:'👁️', glyphAlt:'close-up of a girl’s face',
    ...
    { type:'listening', label:'LISTENING · Q6 · P.2',
      ...
      options:[ {han:'🍵 茶', py:'chá', en:'a cup of tea'},
                {han:'🐈 猫', py:'māo', en:'a cat'},
                {han:'⌚ 手表', py:'shǒubiǎo', en:'a watch'} ],
      answer:0,
    ...
    { type:'listening', label:'LISTENING · Q7 · P.2',
      ...
      prompt:'Which picture matches the dialogue?',
      options:[ {han:'🌏 旅游', py:'lǚyóu', en:'travelling'},
                {han:'🏃 跑步', py:'pǎobù', en:'running'},
                {han:'🍵 茶', py:'chá', en:'a cup of tea'} ],
      answer:1,
    ...
    { type:'listening', label:'LISTENING · Q8 · P.2',
      ...
      prompt:'Which picture matches the dialogue?',
      options:[ {han:'🐈 猫', py:'māo', en:'a cat'},
                {han:'🏃 跑步', py:'pǎobù', en:'running'},
                {han:'⌚ 看表', py:'kàn biǎo', en:'a man checking his watch'} ],
      answer:2,
    ...
    { type:'listening', label:'LISTENING · Q9 · P.2',
      ...
      prompt:'Which picture matches the dialogue?',
      options:[ {han:'🐈 猫', py:'māo', en:'a cat'},
                {han:'🌏 旅游', py:'lǚyóu', en:'travelling'},
                {han:'⚽ 足球', py:'zúqiú', en:'football'} ],
      answer:0,
    ...
    { type:'listening', label:'LISTENING · Q10 · P.2',
      ...
      prompt:'Which picture matches the dialogue?',
      options:[ {han:'⌚ 看表', py:'kàn biǎo', en:'a man checking his watch'},
                {han:'🌏 旅游', py:'lǚyóu', en:'a couple with a globe'},
                {han:'🍵 茶', py:'chá', en:'a cup of tea'} ],
      answer:1,
    ...
    { type:'reading', label:'READING · Q16 · P.4',
      ...
      options:[ {han:'⛄ 雪', py:'xuě', en:'a child with a snowman'},
                {han:'💼 工作', py:'gōngzuò', en:'people at work'},
                {han:'🐈 小猫', py:'xiǎo māo', en:'kittens'} ],
      answer:0,
    ...
    { type:'reading', label:'READING · Q17 · P.4',
      ...
      prompt:'Which picture goes with this sentence?',
      options:[ {han:'🗺️ 旅游', py:'lǚyóu', en:'tourists with a map'},
                {han:'💼 工作', py:'gōngzuò', en:'people at work'},
                {han:'⚽ 足球', py:'zúqiú', en:'boys with a football'} ],
      answer:1,
    ...
    { type:'reading', label:'READING · Q20 · P.4',
      ...
      prompt:'Which picture goes with this sentence?',
      options:[ {han:'🗺️ 旅游', py:'lǚyóu', en:'tourists with a map'},
                {han:'⛄ 雪', py:'xuě', en:'a child with a snowman'},
                {han:'⚽ 足球', py:'zúqiú', en:'boys with a football'} ],
      answer:0,
